    ...
    try:
        ...
        if critical_insights:
            ...
            if supply_chain_compromise:
                ...
                print(
                    "   • Expected behavior: Box should only talk to *.box.com servers"
                )
                ...
                print(
                    "   • High automation score (22.2) indicates malicious bot activity"
                )
                print()
                print("⚠️  WHAT THIS MEANS:")
                print(
                    "   This is likely malicious code injected into the Box application"
                )
                ...
                print(
                    "   where legitimate software is modified to include malicious code."
                )
                print("=" * 60)
                print()
